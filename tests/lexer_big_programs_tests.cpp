...
val safeInt: Int? = 42
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","OPERATOR","KEYWORD","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","OPERATOR","LITERAL:String","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","OPERATOR","KEYWORD","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","OPERATOR","LITERAL:Int","NEWLINE",
      "PUNCT"
  };
  LexerUnitTestSuite::AssertLexemesAndTypesEqual(items, expected_lexemes, expected_types);
}
...
val emptyList: IntArray = IntArray(0)
  ...
  std::vector<std::string> expected_types = {
      ...
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","LITERAL:Int","PUNCT","NEWLINE",
      "IDENT","PUNCT","LITERAL:Int","PUNCT","PUNCT","OPERATOR","LITERAL:Int","NEWLINE",
      "IDENT","PUNCT","LITERAL:Int","PUNCT","PUNCT","OPERATOR","LITERAL:Int","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","LITERAL:Int","PUNCT","NEWLINE",
      "PUNCT"
  };
...
val circle: Circle? = Circle(10.0)
  ...
  std::vector<std::string> expected_types = {
      ...
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","OPERATOR","IDENT","PUNCT","LITERAL:Float","PUNCT","NEWLINE",
      "PUNCT"
  };
  LexerUnitTestSuite::AssertLexemesAndTypesEqual(items, expected_lexemes, expected_types);
}
...
protected val protectedVal: bool = false
}
...
obj.mutable = 30.0
  ...
  std::vector<std::string> expected_types = {
      ...
      "KEYWORD","KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","LITERAL:Bool","NEWLINE",
      "PUNCT","NEWLINE",
      "KEYWORD","IDENT","PUNCT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
...
else if (!a xor b) { sys::Print("Exactly one false") }
...
if (obj is String) { val str: String? = obj as String if (str != null) { sys::Print(str.Length().ToString()) } }
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
      "KEYWORD","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","KEYWORD","IDENT","PUNCT","IDENT","PUNCT","OPERATOR","IDENT","OPERATOR","IDENT","KEYWORD","PUNCT","IDENT","OPERATOR","KEYWORD","PUNCT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","PUNCT","PUNCT","PUNCT","PUNCT","NEWLINE",
      "KEYWORD","KEYWORD","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","IDENT","IDENT","OPERATOR","IDENT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","PUNCT","NEWLINE",
      "KEYWORD","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","LITERAL:String","PUNCT","PUNCT","NEWLINE",
      "PUNCT"
  };
  LexerUnitTestSuite::AssertLexemesAndTypesEqual(items, expected_lexemes, expected_types);
...
if (value > 10) { return value * 2 }
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
...
var counter: int = 0
while (counter < n) { counter = counter + 1 if (counter % 2 == 0) continue sys::Print(counter.ToString()) }
return counter
})OVUM";
  Lexer lexer(src);
  auto tokens = lexer.Tokenize();
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","LITERAL:Int","NEWLINE",
      "KEYWORD","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","LITERAL:Int","KEYWORD","PUNCT","IDENT","OPERATOR","LITERAL:Int","OPERATOR","LITERAL:Int","PUNCT","KEYWORD","IDENT","OPERATOR","IDENT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","PUNCT","PUNCT","NEWLINE",
...
return sum
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","LITERAL:Int","NEWLINE",
      "KEYWORD","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","KEYWORD","PUNCT","IDENT","OPERATOR","LITERAL:Int","PUNCT","KEYWORD","IDENT","OPERATOR","IDENT","OPERATOR","IDENT","PUNCT","NEWLINE",
      "KEYWORD","IDENT","NEWLINE",
      "PUNCT"
  };
  LexerUnitTestSuite::AssertLexemesAndTypesEqual(items, expected_lexemes, expected_types);
...
for (row in matrix) { var i: int = 0 while (i < row.Length()) { if (row[i] == 0) { continue } sys::Print(row[i].ToString()) i = i + 1 if (i > 5) break } }
})OVUM";
  Lexer lexer(src);
  auto tokens = lexer.Tokenize();
  auto items = LexerUnitTestSuite::ExtractLexemesAndTypes(tokens);
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
      "KEYWORD","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","LITERAL:Int","KEYWORD","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","PUNCT","KEYWORD","PUNCT","IDENT","PUNCT","IDENT","PUNCT","OPERATOR","LITERAL:Int","PUNCT","PUNCT","KEYWORD","PUNCT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","LITERAL:Int","KEYWORD","PUNCT","IDENT","OPERATOR","LITERAL:Int","PUNCT","KEYWORD","PUNCT","PUNCT","NEWLINE",
      "PUNCT"
  };
  LexerUnitTestSuite::AssertLexemesAndTypesEqual(items, expected_lexemes, expected_types);
}
...
var i: int = 0
while (i < arr.Length()) { sys::Print((i.ToString() + ": " + arr[i].ToString())) i = i + 1 }
})OVUM";
  Lexer lexer(src);
  auto tokens = lexer.Tokenize();
  auto items = LexerUnitTestSuite::ExtractLexemesAndTypes(tokens);
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","LITERAL:Int","NEWLINE",
      "KEYWORD","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","PUNCT","IDENT","OPERATOR","LITERAL:String","OPERATOR","IDENT","PUNCT","IDENT","PUNCT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","LITERAL:Int","PUNCT","NEWLINE",
      "PUNCT"
  };
  LexerUnitTestSuite::AssertLexemesAndTypesEqual(items, expected_lexemes, expected_types);
}
...
return newList
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","OPERATOR","LITERAL:Int","PUNCT","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","LITERAL:Int","NEWLINE",
      "KEYWORD","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","OPERATOR","IDENT","PUNCT","IDENT","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","LITERAL:Int","PUNCT","NEWLINE",
      "IDENT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","OPERATOR","LITERAL:Int","NEWLINE",
      "KEYWORD","IDENT","NEWLINE",
      "PUNCT"
  };
  LexerUnitTestSuite::AssertLexemesAndTypesEqual(items, expected_lexemes, expected_types);
...
return null
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","PUNCT","NEWLINE",
      "KEYWORD","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","KEYWORD","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","KEYWORD","IDENT","PUNCT","IDENT","PUNCT","PUNCT","PUNCT","NEWLINE",
...
sys::Print(length.ToString())
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","OPERATOR","LITERAL:Int","NEWLINE",
      "IDENT","OPERATOR","IDENT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","NEWLINE",
      "PUNCT"
  };
  LexerUnitTestSuite::AssertLexemesAndTypesEqual(items, expected_lexemes, expected_types);
...
return default
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","LITERAL:Int","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","OPERATOR","LITERAL:String","NEWLINE",
      "KEYWORD","IDENT","NEWLINE",
      "PUNCT"
  };
  LexerUnitTestSuite::AssertLexemesAndTypesEqual(items, expected_lexemes, expected_types);
...
if (safe == null) { sys::Print("Is null") }
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
      "KEYWORD","PUNCT","IDENT","OPERATOR","KEYWORD","PUNCT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","LITERAL:String","PUNCT","KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","OPERATOR","IDENT","NEWLINE",
      "KEYWORD","PUNCT","IDENT","OPERATOR","KEYWORD","PUNCT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","LITERAL:String","PUNCT","PUNCT","NEWLINE",
      "PUNCT"
  };
  LexerUnitTestSuite::AssertLexemesAndTypesEqual(items, expected_lexemes, expected_types);
}
...
if (obj is Int?) { val casted: Int? = obj as Int? val value: int = casted ?: 0 sys::Print(value.ToString()) }
val risky: Int = obj as Int
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
      "KEYWORD","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","KEYWORD","IDENT","PUNCT","IDENT","PUNCT","OPERATOR","IDENT","OPERATOR","IDENT","PUNCT","KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","LITERAL:Int","IDENT","OPERATOR","IDENT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","PUNCT","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","IDENT","NEWLINE",
      "PUNCT"
  };
  LexerUnitTestSuite::AssertLexemesAndTypesEqual(items, expected_lexemes, expected_types);
}
...
return copy
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","PUNCT","NEWLINE",
      "KEYWORD","PUNCT","IDENT","OPERATOR","KEYWORD","PUNCT","KEYWORD","KEYWORD","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","OPERATOR","IDENT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","LITERAL:Int","NEWLINE",
      "KEYWORD","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","OPERATOR","IDENT","PUNCT","IDENT","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","LITERAL:Int","PUNCT","NEWLINE",
      "KEYWORD","IDENT","NEWLINE",
      "PUNCT"
...
TEST(LexerUnitTestSuite, ChainSafe) {
  const std::string src = R"OVUM(class Nested { public val Inner: String? public fun Nested(s: String?): Nested { this.Inner = s return this } }
...
sys::Print(len.ToString())
  ...
  auto items = LexerUnitTestSuite::ExtractLexemesAndTypes(tokens);
  std::vector<std::string> expected_lexemes = {
      "class","Nested","{","public","val","Inner",":","String","?","public","fun","Nested","(","s",":","String","?",")",":","Nested","{","this",".","Inner","=","s","return","this","}","}","\\n",
      "fun","ChainSafe","(","nested",":","Nested","?",")",":","Void","{","\\n",
      "val","len",":","int","=","nested","?.","Inner","?.","Length","(",")","?:","0","\\n",
      "sys","::", "Print","(","len",".","ToString","(",")",")","\\n",
      "}"
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","KEYWORD","KEYWORD","IDENT","PUNCT","IDENT","PUNCT","KEYWORD","KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","IDENT","OPERATOR","IDENT","KEYWORD","IDENT","PUNCT","PUNCT","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","OPERATOR","LITERAL:Int","NEWLINE",
      "IDENT","OPERATOR","IDENT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","NEWLINE",
      "PUNCT"
  };
  LexerUnitTestSuite::AssertLexemesAndTypesEqual(items, expected_lexemes, expected_types);
...
return Int(aVal + bVal)
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","LITERAL:Int","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","IDENT","OPERATOR","LITERAL:Int","NEWLINE",
      "KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","NEWLINE",
      "PUNCT"
  };
  LexerUnitTestSuite::AssertLexemesAndTypesEqual(items, expected_lexemes, expected_types);
}
TEST(LexerUnitTestSuite, UnsafeNullable) {
  const std::string src = R"OVUM(fun UnsafeNullable(ptr: Pointer?): Void {
    unsafe { if (ptr != null) { val bytes: ByteArray = (ptr as ByteArray) } }
    })OVUM";
  Lexer lexer(src);
  auto tokens = lexer.Tokenize();
  auto items = LexerUnitTestSuite::ExtractLexemesAndTypes(tokens);
  ...
  std::vector<std::string> expected_types = {
      "KEYWORD","IDENT","PUNCT","IDENT","PUNCT","IDENT","PUNCT","PUNCT","IDENT","PUNCT","NEWLINE",
      "KEYWORD","PUNCT","KEYWORD","PUNCT","IDENT","OPERATOR","KEYWORD","PUNCT","PUNCT","KEYWORD","IDENT","PUNCT","IDENT","OPERATOR","PUNCT","IDENT","OPERATOR","IDENT","PUNCT","PUNCT","PUNCT","NEWLINE",
      "PUNCT"
  };
  LexerUnitTestSuite::AssertLexemesAndTypesEqual(items, expected_lexemes, expected_types);
}
